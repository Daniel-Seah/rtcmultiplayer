...
window.fbAsyncInit = function() {
	// init the FB JS SDK
	FB.init({
		appId : RTCMULTIPLAYER.Properties.APP_ID,
		channelUrl : RTCMULTIPLAYER.Properties.APP_DOMAIN + 'channel.html',
		status : true,
		cookie : true,
		xfbml : true
	});
...
// Store FB session information in global object
var session = {
	userID	: null,
	token	: null,
	signed	: null
